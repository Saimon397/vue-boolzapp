...
const app = createApp({
    data() {
        return {
            ...
            message: '',
            filteredContacts: [],
            randomAnswers: ['Ciao!', 'Come stai ?', 'Tutto bene ?', 'Va bene', 'Ci vediamo stasera ?', 'Stasera alle 19:00, mi raccomando !!!', 'Non ho il tuo numero, chi sei ?', 'Perchè ?', 'Ma scherzi !?!', 'Ti odio !!', 'Tutto bene.. Tu ?', 'Bene grazie'],
            contacts: [{
                id: 1,
                name: 'Michele',
                avatar: '_1',
    ...
    methods: {
        ...
        sendMessage() {
            ...
            const replyMessage = {
                date: 'Oggi ' + dayjs().format('HH:mm'),
                message: this.randomAnswers[Math.floor(Math.random() * this.randomAnswers.length)],
                status: 'received'
            }
        ...
        deleteMessage(index, currentIndex) {
